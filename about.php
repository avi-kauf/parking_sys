...
<p> In this project we planned a system where a user can reserve a single 
    ...
    that we learned before such as HTML5,CSS and Java Script.</p>

<p>The idea is pretty simple, you create a user in the login page and you are 
...
<p>This project is a part of the Web Applications &amp Dynamic Web Interfaces
Course (35-602) from the Information Science Dept. in Bar-Ilan University. It
was done in the 2nd semester of the year 5776.</p>

<h2>Who worked on it?</h2>
<p> In our team we have Ariella Epstein (328606686), Avraham Kauffmann 
    (333789436)and Orchan Magaramov.</p>
</div>
<?php
include 'footer.php';
?>
